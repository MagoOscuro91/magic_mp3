...
fondo = tk.Label(ventana) # fondo = tk.Label(ventana, image=imagen_fondo)
...
boton_mp4 = ttk.Button(ventana, text="MP4", command=lambda: (descargar_mp4(url=entry_url.get())), width=10)
boton_mp4.pack(pady=10)
boton_mp4.place(x=10, y=410)

boton_mp3 = ttk.Button(ventana, text="MP3", command=lambda: (descargar_mp3_2(url=entry_url.get())), width=10)
...
start_time=entry_inicio.get(), end_time=entry_final.get())), width=10)
